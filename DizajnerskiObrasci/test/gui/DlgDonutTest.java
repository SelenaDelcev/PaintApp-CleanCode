...
public class DlgDonutTest {
	...
	@Test
    public void testOKButtonClickWithSetRadius() {
        dialog.getTxtX().setText("100");
        dialog.getTxtY().setText("150");
	...
	@Test
    public void testOKButtonClickWithSetInnerRadius() {
        dialog.getTxtX().setText("100");
        dialog.getTxtY().setText("150");
        dialog.getTxtRadius().setText("");
        dialog.getTxtInnerRadius().setText("40");
        dialog.getOkButton().doClick();
        assertFalse(dialog.isOK());
        assertTrue(dialog.isVisible());
        verifyEmptyInputInfoMessage();
	...
	@Test
    public void testOKButtonClickWithInnerRadiusLessThanZero() {
		dialog.getTxtX().setText("100");
        dialog.getTxtY().setText("150");
        dialog.getTxtRadius().setText("80");
        dialog.getTxtInnerRadius().setText("-40");
	...
	@Test
    public void testOKButtonClickWithRadiusAndInnerRadiusLessThanZero() {
		dialog.getTxtX().setText("100");
        dialog.getTxtY().setText("150");
        dialog.getTxtRadius().setText("-80");
        dialog.getTxtInnerRadius().setText("-40");
	...
	@Test
    public void testOKButtonClickWhenInnerRadiusGreaterThanRadius() {
		dialog.getTxtX().setText("100");
        dialog.getTxtY().setText("150");
        dialog.getTxtRadius().setText("80");
        dialog.getTxtInnerRadius().setText("140");
        dialog.getOkButton().doClick();
        assertFalse(dialog.isOK());
        verifyInnerRadiusLessThanRadiusInfoMessage();
    }
	...
	@Test
    public void testCoordinateInputWithValidCharacterForInnerRadius() {
        KeyEvent event = new KeyEvent(dialog.getTxtInnerRadius(), KeyEvent.KEY_TYPED, System.currentTimeMillis(), 0, KeyEvent.VK_UNDEFINED, '5');
        dialog.handleInputValidation(event);
        assertFalse(event.isConsumed());
    }
	...
	@Test
    public void testCoordinateInputWithInvalidCharacterForInnerRadius() {
        KeyEvent event = new KeyEvent(dialog.getTxtInnerRadius(), KeyEvent.KEY_PRESSED, System.currentTimeMillis(), 0, KeyEvent.VK_UNDEFINED, 'a');
        dialog.handleInputValidation(event);
        assertTrue(event.isConsumed());
    }
	...
	private void verifyNegativeInputInfoMessage() {
    	verify(optionPane).showMessageDialog(null, "Radius and inner radius must be greater than 0!", "Error", JOptionPane.WARNING_MESSAGE);
	}
	
	private void verifyInnerRadiusLessThanRadiusInfoMessage() {
    	verify(optionPane).showMessageDialog(null, "Inner radius must be smaller than radius!", "Error", JOptionPane.WARNING_MESSAGE);
	}
