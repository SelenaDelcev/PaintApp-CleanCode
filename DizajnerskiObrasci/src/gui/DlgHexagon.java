...
@Getter
@Setter
public class DlgHexagon extends JDialog implements CommonDialog{
	...
	private void handleOkButtonClick() {
		if (txtX.getText().isEmpty() || txtY.getText().isEmpty() || txtRadius.getText().isEmpty()) {
			...
			optionPane.showMessageDialog(null, "Radius must be greater than 0!", "Error", JOptionPane.WARNING_MESSAGE);
		} else {
			isOK = true;
			dispose();
		}
